...
func matrix4x4_translate(translate: vector_float3) -> matrix_float4x4 {
    var m = matrix_identity_float4x4
    translateMatrix(matrix: &m, position: translate)
    return m
}

func matrix4x4_scale(scale: vector_float3) -> matrix_float4x4 {
    var m = matrix_identity_float4x4
    scaleMatrix(matrix: &m, scale: scale)
    return m
}
